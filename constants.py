...
ALL_WORDS = DATA + 'all_words_nltk.txt'
ALL_POSES = DATA + 'all_poses_nltk.txt'
ALL_SYNSETS = DATA + 'all_hypernyms_nltk.txt'
ALL_DEPENDS = DATA + 'all_depend_nltk.txt'

# TRIMMED_W2V = W2V_DATA + 'word2vec_nlplab.npz'
